...
public class PaymentConfirmationIntegration implements PaymentConfirmationCallback {
    ...
    public AmountData getFullAmountData(
        ...
        long oldTotal = CurrencyUtils.parseValue(amountData.getEstimatedTotal());

        // Get existing tax
        long taxValue = CurrencyUtils.parseValue(amountData.getTax());
        ...
        if (selectedMethodId == null || selectedMethodId.isEmpty() || masterPassAddress == null) {
            ...
            return new AmountData(amountData.getEstimatedTotal(),
                    CurrencyUtils.convertToText(taxValue, amountData.getCurrency(), false),
                    CurrencyUtils.convertToText(newTotal, amountData.getCurrency(), false),
