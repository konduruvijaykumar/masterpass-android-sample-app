...
public enum ShippingMethodsManager {
    ...
    public ArrayList<ShippingMethod> getSupportedShippingMethods() {
        ...
        try {
            shippingMethodList.add(new ShippingMethod("1", "2-day Shipping", "2-day Shipping", "2.00"));
            shippingMethodList.add(new ShippingMethod("2", "Overnight Shipping", "Overnight Shipping", "5.00"));
