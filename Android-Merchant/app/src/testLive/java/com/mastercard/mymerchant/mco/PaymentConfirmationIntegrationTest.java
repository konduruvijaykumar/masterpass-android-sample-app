...
public class PaymentConfirmationIntegrationTest {
    ...
    public void testGetFullAmountData() throws Exception {
        ...
        AmountData amountData = new AmountData("10.00", "5.00", "15.00", Currency.getInstance("USD"));
        ...
        amountData = new AmountData("10.00", "5.00", "15.00", Currency.getInstance("USD"));
        ...
        amountData = new AmountData("1000", "500", "1500", Currency.getInstance("JPY"));
        newAmountData = pci.getFullAmountData(null, "1", amountData);
        assertEquals(amountData.getCurrency(), newAmountData.getCurrency());
        assertEquals(amountData.getEstimatedTotal(), newAmountData.getEstimatedTotal());
        assertEquals(amountData.getTax(), newAmountData.getTax());
        ...
        amountData = new AmountData("10.00", "0.50", "10.50", Currency.getInstance("USD"));
        newAmountData = pci.getFullAmountData(masterPassAddress, null, amountData);
        assertEquals(amountData.getCurrency(), newAmountData.getCurrency());
        assertEquals(amountData.getEstimatedTotal(), newAmountData.getEstimatedTotal());
        assertEquals("0.50", newAmountData.getTax());
        assertEquals("10.50", newAmountData.getTotal());

        // As above, different tax bucket
        masterPassAddress.setAdminArea("DE");
        amountData = new AmountData("10.00", "1.00", "11.00", Currency.getInstance("USD"));
        newAmountData = pci.getFullAmountData(masterPassAddress, null, amountData);
        assertEquals("1.00", newAmountData.getTax());
        assertEquals("11.00", newAmountData.getTotal());

        // As above, different tax bucket
        masterPassAddress.setAdminArea("SD");
        amountData = new AmountData("10.00", "1.00", "11.00", Currency.getInstance("USD"));
        newAmountData = pci.getFullAmountData(masterPassAddress, null, amountData);
        assertEquals("0.00", newAmountData.getTax());
        assertEquals("10.00", newAmountData.getTotal());
        ...
        assertEquals(amountData.getEstimatedTotal(), newAmountData.getEstimatedTotal());
        assertEquals(amountData.getTax(), newAmountData.getTax());
        assertEquals("12.50", newAmountData.getTotal());
        ...
        assertEquals(amountData.getEstimatedTotal(), newAmountData.getEstimatedTotal());
        assertEquals(amountData.getTax(), newAmountData.getTax());
        assertEquals("15.50", newAmountData.getTotal());

        // As above + different currency
        masterPassAddress.setAdminArea("NY");
        amountData = new AmountData("1000", "50", "1050", Currency.getInstance("JPY"));
        newAmountData = pci.getFullAmountData(masterPassAddress, "2", amountData);
        assertEquals(amountData.getCurrency(), newAmountData.getCurrency());
        assertEquals(amountData.getEstimatedTotal(), newAmountData.getEstimatedTotal());
        assertEquals(amountData.getTax(), newAmountData.getTax());
        assertEquals("1550", newAmountData.getTotal());
    }
}